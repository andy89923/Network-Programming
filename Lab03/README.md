...
:::danger
If you have difficulties connecting to the Internet, or the bandwidth in your network is unstable. You can download our sink server from here (for [x86-64](http://inp111.zoolab.org/lab03.2/sink) only) and modify your client to connect to the local server instead of our Internet server.
